...
while(choix !== 0){
  menu();
    ...
    switch(choix){
        ...
        break;
        case 5 :
            var nom = readline.question("Quel est le nom recherché ? ");
 ...
 * @param {Array} tab tab : tableau contenant les infos d'un personnage
 */
...
function creerPerso(){
    ...
    var age = readline.questionInt("Quel est l'âge du personnage ? ")
    perso.push(nom);
    perso.push(age);
    var sexeInt = 0
